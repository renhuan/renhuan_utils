...
public class PlayPauseView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mGapWidth = SizeUtils.dp2px(ta.getDimension(R.styleable.PlayPauseView_gap_width, 0));
        mBorderWidth = SizeUtils.dp2px(ta.getDimension(R.styleable.PlayPauseView_border_width, 2));
        ...
        mAnimDuration = ta.getInt(R.styleable.PlayPauseView_anim_duration, 300);
